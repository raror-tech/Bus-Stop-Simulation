...
void texti()
{
	...
	glRasterPos3f(750, 250 + 100, 0);

	for (k = 0; k < strlen(string2); k++)
		glutBitmapCharacter(font2, string2[k]);

	char string3[] = "Reena Arora";
	void* font3 = GLUT_BITMAP_HELVETICA_18;

	glColor3f(0.0, 0.0, 0.0);


	glRasterPos3f(750, 220 + 100, 0);
	...
	char string4[] = "Akashdeep Singh Gill";
	void* font4 = GLUT_BITMAP_HELVETICA_18;

	glColor3f(0.0, 0.0, 0.0);


	glRasterPos3f(750, 220 + 70, 0);
	...
	char string8[] = "Click on the left button to start";
	void* font8 = GLUT_BITMAP_HELVETICA_18;

	glColor3f(0.0, 0.0, 0.0);


	glRasterPos3f(720, 200, 0);
